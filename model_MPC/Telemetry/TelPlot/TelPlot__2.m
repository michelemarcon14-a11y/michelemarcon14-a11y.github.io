...
clc;
%% TAB
TelPlot_2= figure('Name', 'Plotting Telemetries 2', 'WindowState', 'maximized');
...
%plot
figure(TelPlot_2);axes('Parent', tab4);subplot(1,2,1);
...
%plot
figure(TelPlot_2);axes('Parent', tab4);subplot(1,2,2);
