...
subplot(1,2,1);
plot(telemetry_1.Corr_Dist.Time(20:65),telemetry_1.Corr_Dist.Value(20:65),  'LineWidth', 1.5);
xlim([539.2 543.7]);
grid minor; title('Telemetry'); xlabel('Time [s]'); ylabel('Corr-Dist');
figure(TelPlot_1);axes('Parent', tab1);
subplot(1,2,2);
plot(simtel.time(1:9130),simtel.dynamics.x(1:9130),  'LineWidth', 1.5);
...
subplot(1,2,1);
plot(telemetry_1.Engine_Speed.Time(20:65),telemetry_1.Engine_Speed.Value(20:65),  'LineWidth', 1.5);
...
%plot
figure(TelPlot_1);axes('Parent', tab4_1);
subplot(1,2,1);
...
%plot
figure(TelPlot_1);axes('Parent', tab4);
subplot(1,2,1);
