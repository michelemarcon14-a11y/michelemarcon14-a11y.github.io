...
%plot
figure(TelPlot_3);axes('Parent', tab4_1);
subplot(1,2,1);
...
%plot
figure(TelPlot_3);axes('Parent', tab4);
subplot(1,2,1);
...
telemetry_3.Wheel_Speed_Front_Left.Value = Wheel_Speed_Front_Left.Value;
telemetry_3.Wheel_Speed_Front_Left.Time = Wheel_Speed_Front_Left.Time;
%plot
figure(TelPlot_3);axes('Parent', tab10);subplot(2,2,1);
plot(telemetry_3.Wheel_Speed_Front_Left.Time,telemetry_3.Wheel_Speed_Front_Left.Value,  'LineWidth', 1.5);
grid minor; title('Wheel Speed Front Left'); xlabel('Time [s]'); ylabel('Wheel Speed Front Left');

%% Wheel_Speed_Front_Right
telemetry_3.Wheel_Speed_Front_Right.Value = Wheel_Speed_Front_Right.Value;
telemetry_3.Wheel_Speed_Front_Right.Time = Wheel_Speed_Front_Right.Time;
%plot
figure(TelPlot_3);axes('Parent', tab10);subplot(2,2,2);
plot(telemetry_3.Wheel_Speed_Front_Right.Time,telemetry_3.Wheel_Speed_Front_Right.Value,  'LineWidth', 1.5);
grid minor; title('Wheel Speed Front Right'); xlabel('Time [s]'); ylabel('Wheel Speed Front Right');

%% Wheel_Speed_Rear_Left
telemetry_3.Wheel_Speed_Rear_Left.Value = Wheel_Speed_Rear_Left.Value;
telemetry_3.Wheel_Speed_Rear_Left.Time = Wheel_Speed_Rear_Left.Time;
%plot
figure(TelPlot_3);axes('Parent', tab10);subplot(2,2,3);
plot(telemetry_3.Wheel_Speed_Rear_Left.Time,telemetry_3.Wheel_Speed_Rear_Left.Value,  'LineWidth', 1.5);
grid minor; title('Wheel Speed Rear Left'); xlabel('Time [s]'); ylabel('Wheel Speed Rear Left');

%% Wheel_Speed_Rear_Right
telemetry_3.Wheel_Speed_Rear_Right.Value = Wheel_Speed_Rear_Right.Value;
telemetry_3.Wheel_Speed_Rear_Right.Time = Wheel_Speed_Rear_Right.Time;
%plot
figure(TelPlot_3);axes('Parent', tab10);subplot(2,2,4);
plot(telemetry_3.Wheel_Speed_Rear_Right.Time,telemetry_3.Wheel_Speed_Rear_Right.Value,  'LineWidth', 1.5);
